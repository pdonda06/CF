...
export default function AptitudeStats({ questions, answers, score, category }) {
      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="text-center">
              <div className={`text-3xl font-bold mb-1 ${getPerformanceColor((score / questions.length) * 100)}`}>
                ...
                return (
                  <div key={category} className="p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
                    <p className="text-sm text-yellow-800">
                      <strong>Focus on {category}:</strong> Consider practicing more {category.toLowerCase()} problems to improve your performance.
                    </p>
                  </div>
                );
              }
             ...
             Object.values(difficultyStats).every((total, index) => {
              ...
              <div className="p-3 bg-green-50 border border-green-200 rounded-lg">
                <p className="text-sm text-green-800">
                  <strong>Excellent performance!</strong> You're well-prepared for aptitude tests and interviews.
                </p>
              </div>
            )}
          </div>
